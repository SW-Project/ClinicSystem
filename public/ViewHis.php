...
require_once(__ROOT__ . "View/Staff/ViewHistory.php");
require_once(__ROOT__ . "Database/Db.php");
session_start();
$model = new Histories();
$controller = new PatientsController($model);
$view = new View_History($controller, $model);
$db = new DB();
?>
<!DOCTYPE html>
<html lang="en">
...
>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="ViewHis.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Patients' Histories</span></a>
      </li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
              <a class="nav-link dropdown-toggle" href="ViewHistory.php" id="searchDropdown" role="button" data-toggle="dropdown"  aria-haspopup="true" aria-expanded="false">
