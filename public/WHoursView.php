...
require_once(__ROOT__ . "controller/DayLimitController.php");
require_once(__ROOT__ . "View/Staff/viewTime.php");
...
$controller = new DayLimitController($model);
$view = new viewTime($controller, $model);
$db = new DB();
