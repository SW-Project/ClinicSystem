<?php
define('__ROOT__', "../App/");
require_once(__ROOT__ . "model/MedHistories.php");
...
$view = new ViewDR($controller, $model);
$db = new DB();
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <hr class="sidebar-divider my-0">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="Dr5.php">
                <i class="fas fa-cut"></i>
                <span>Medical Histories</span></a>
            </li>
      <!-- Divider -->
