...
if(isset($_POST['login']))	{
	...
	$sql = "SELECT * FROM Patients where username='$Username' and pass='$encrypted'";
	$dbh = new DB();
            ...
            top: -40px;width: 95px;height: 95px;border-radius: 50%;background: transparet;padding: 20px;text-align: center;'>
             <h5 style='text-align: center;'>Failed</h5>
                 ...
                 <div class='modal-body'>
                   <p>Your ID or your Password are wrong please check and try again ... Thank You</p>
                 </div>
                     <div class='modal-footer'>
                             ...
                             <button type='button' class='btn btn-danger' data-dismiss='modal' onclick='myFunction()'>Back</button>
                                         ...
                                         function myFunction()
                                         {
                                           location.href='http://localhost/SW/Public/login.php';
                                         }
                                         </script>
                     </div>
                 </div>
			...
			<div class="top-bar py-3">
				<div class="container">
					<div class="row">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 top-social-agile text-md-right text-center mt-md-0 mt-2">
							<div class="row">
								<div class="offset-xl-4 offset-lg-4">
								</div>
								<div class="col-xl-3 col-lg-3 col-3 top-w3layouts p-md-0 text-right">
									<!-- login -->
									<a href="login.php" class="login-button-2 text-uppercase text-bl">
										<span class="fa fa-sign-in mr-2"></span>Login</a>
									<!-- //login -->
								</div>
								<div class="col-xl-4 col-lg-4 col-4 header-w3layouts text-md-right text-left">
									<!-- register -->
