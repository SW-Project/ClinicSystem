<?php
define('__ROOT__', "../App/");
require_once(__ROOT__ . "model/OperationsModel.php");
require_once(__ROOT__ . "model/PatientsModel.php");
require_once(__ROOT__ . "controller/OperationController.php");
require_once(__ROOT__ . "View/Staff/ViewDR.php");
...
$controller = new OperationsController($model);


$controller = new OperationsController($model);
$view = new ViewDR($controller, $model1);
$db = new DB();
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="http://localhost/SW/lib/images/Dr.jpg">
              </a>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="stafflog.html" data-toggle="modal" data-target="#logoutModal">
