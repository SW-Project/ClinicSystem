...
require_once(__ROOT__ . "View/Staff/addOperation.php");
...
$controller = new OperationsController($model);
$view = new addOperations($controller, $model1);
$db = new DB();
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Book_operation.php">
