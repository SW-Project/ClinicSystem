...
require_once(__ROOT__ . "View/Patient/StaffUser.php");
session_start();
$id=$_SESSION["SID"];

$model = new Staff($id);
$controller = new StaffsController($model);
$view = new ViewStaff($controller, $model);

if(isset($_POST['submit'])){
	$idname = $_POST['name'];
    $password = $_POST['password'];
    $query = "SELECT *     FROM staff WHERE SID='".$idname."' AND pass= '".$password."'";
...
<link href="http://localhost/SW/lib/css/sb-admin-2.min.css" rel="stylesheet">
	...
	<link href="//fonts.googleapis.com/css?family=Mukta:200,300,400,500,600,700,800&amp;subset=devanagari,latin-ext" rel="stylesheet">
	  ...
	  <script src="http://localhost/SW/lib/vendor/jquery/jquery.min.js"></script>
  <script src="http://localhost/SW/lib/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="http://localhost/SW/lib/vendor/jquery-easing/jquery.easing.min.js"></script>
		...
		<div class="container-fluid">
			<div class="row slide">
				...
				<div class="col-xl-4 triple-sec p-5 text-center">
					...
					<a href="/Applications/XAMPP/xamppfiles/htdocs/web/gallery.html" class="some-small-btn bg-wh btn text-bl font-weight-bold mb-xl-0 mb-4">Check It</a>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="gallery.html">We insure about your satisfaction</a>
								</h5>
							...
							<a href="gallery.html" class="blog-btn btn">Read more</a>
						</div>
					</div>
				</div>
				<!-- //blog grid -->
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-body border border-bottom-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="gallery.html">Exercise regularly</a>
								</h5>
								<div class="blog_w3icon">
									<span>
										Jan 14, 2020</span>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-body border border-bottom-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="gallery.html">Fellow up system </a>
								</h5>
								<div class="blog_w3icon">
									<span>
										Jan 20, 2020 </span>
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						...
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="gallery.html">The assistant</a>
								</h5>
								<div class="blog_w3icon">
									<span>
										Jan 24, 2020 </span>
