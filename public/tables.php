...
require_once(__ROOT__ . "View/Staff/ViewRecep.php");

$model = new Appointments();
$controller = new AppointmentController($model);
$view = new Rec($controller, $model);
?>
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost/SW/Public/tables.php">
...
>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="http://localhost/SW/Public/tables.php">
