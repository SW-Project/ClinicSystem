...
define('__ROOT__', "../App/");
require_once(__ROOT__ . "model/AdminsModel.php");
//require_once(__ROOT__ . "model/AdminModel.php");
require_once(__ROOT__ . "controller/AdminController.php");
require_once(__ROOT__ . "View/Staff/StaffReg.php");
...
$model = new Admins();
//$model = new Admins($_SESSION["SID"]);
$controller = new AdminsController($model);
$view = new viewStaffReg($controller, $model);
$db = new DB();
...
<link href="http://localhost/SW/lib/js/bootbox.all" rel="stylesheet">
<link href="http://localhost/SW/lib/js/bootbox" rel="stylesheet">
<link href="http://localhost/SW/lib/js/bootbox.all.min" rel="stylesheet">
<link href="http://localhost/SW/lib/js/bootbox.min" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <hr class="sidebar-divider my-0">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="Admin5.php">
                <i class="fas fa-fw fa-table"></i>
                <span>View Appoitments</span></a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="Admin7.php">
                <i class="fas fa-history"></i>
                <span>View Histories</span></a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="Admin8.php">
                <i class="far fa-sticky-note"></i>
                <span>View Reports</span></a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="Book_operation.php">
