...
--
-- Host: localhost
-- Generation Time: Apr 01, 2020 at 02:25 AM
...
INSERT INTO `Users` (`UID`, `Fname`, `Mname`, `Lname`, `gender`, `mobile`, `email`, `pass`, `User_type_id`, `message`, `BirthDay`, `BirthMonth`, `BirthYear`) VALUES
(1, 'Sandra', 'Sandra', 'Sandra', 'Female ', '01000', '', '$2y$10$1mMZyAgkT1X8r4HdTAYNAe0EW3XbhXMQ8saKV92OCAiXMBNWPdMlO', 5, '', '7', 'April', 1999);
...
--
-- AUTO_INCREMENT for table `Day_Limit`
--
ALTER TABLE `Day_Limit`
...
--
ALTER TABLE `History`
  MODIFY `Med_history_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `Illnesses`
  MODIFY `Illnesses_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `injections`
--
ALTER TABLE `injections`
  MODIFY `injections_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `mess_type`
  MODIFY `mess_type_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `Ops_Types`
--
ALTER TABLE `Ops_Types`
  MODIFY `Op_type_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `appointments`
  ADD CONSTRAINT `appointments_ibfk_1` FOREIGN KEY (`appointment_id`) REFERENCES `app_type` (`app_type_id`),
  ADD CONSTRAINT `appointments_ibfk_2` FOREIGN KEY (`CID`) REFERENCES `clinics` (`CID`),
...
--
ALTER TABLE `Day_Limit`
  ADD CONSTRAINT `day_limit_ibfk_1` FOREIGN KEY (`app_type_id`) REFERENCES `app_type` (`app_type_id`),
  ADD CONSTRAINT `day_limit_ibfk_2` FOREIGN KEY (`CID`) REFERENCES `clinics` (`CID`);

--
-- Constraints for table `History`
--
ALTER TABLE `History`
  ADD CONSTRAINT `history_ibfk_1` FOREIGN KEY (`PID`) REFERENCES `Patients` (`PID`);

--
-- Constraints for table `Illnesses`
--
ALTER TABLE `Illnesses`
  ADD CONSTRAINT `illnesses_ibfk_1` FOREIGN KEY (`PID`) REFERENCES `Patients` (`PID`),
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`mess_type`) REFERENCES `mess_type` (`mess_type_id`),
  ADD CONSTRAINT `message_ibfk_2` FOREIGN KEY (`Reciever_ID`) REFERENCES `Users` (`UID`),
  ADD CONSTRAINT `message_ibfk_3` FOREIGN KEY (`Sender_ID`) REFERENCES `Users` (`UID`);
...
ALTER TABLE `Patients`
  ...
  ADD CONSTRAINT `patients_ibfk_2` FOREIGN KEY (`Illnesses_id`) REFERENCES `Illnesses` (`Illnesses_id`),
  ADD CONSTRAINT `patients_ibfk_3` FOREIGN KEY (`injections_id`) REFERENCES `injections` (`injections_id`),
  ADD CONSTRAINT `patients_ibfk_4` FOREIGN KEY (`Med_history_id`) REFERENCES `History` (`Med_history_id`),
  ADD CONSTRAINT `patients_ibfk_5` FOREIGN KEY (`Op_id`) REFERENCES `Operations` (`Op_id`),
  ADD CONSTRAINT `patients_ibfk_6` FOREIGN KEY (`Report_id`) REFERENCES `Reports` (`Report_id`);

--
-- Constraints for table `Payment`
--
ALTER TABLE `Payment`
  ADD CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`Pay_type`) REFERENCES `Pay_type` (`Pay_type_id`),
...
ALTER TABLE `staff`
  ...
  ADD CONSTRAINT `staff_ibfk_3` FOREIGN KEY (`SID`) REFERENCES `Users` (`UID`);
