...
\begin{itemize}
\item All Patients should view and edit their information including their medical description and hobbies description.
\item Doctor can view patient's information but only can edit their medical history.
...
\begin{itemize}
  \item Patients have the ability to choose the time of appointment they want to reserve, Also, they can edit or delete them and they choose the branch(Location of the clinic) they want at first.
...
\begin{itemize}
\item Receptionists and assistants are responsible to manage the chatting system.
\item Patients have the ability to send messages to the clinic to ask for anything and the assistant is responsible to handle their questions and requests.
\item Patients can view their history messages also.

  \item Admin have the ability to select specific patients to broadcast the message to them.
  
  \item Receptionists send notification either by mail or SMS to the patient to en-form them if the doctor cancelled any reservations.
  \end{itemize}
  
\subsection{Operation System}
\begin{itemize}
  \item The doctor has the ability to add operation to the patient if needed.
  \item Also the assistant can view the operations and add or edit anything in them.
 
  \end{itemize}
  
\subsection{Administrator System}
\begin{itemize}
\item The Admin can view everything in the system and has the authority to do all staff's functions.   
\end{itemize}
